...
* 前17个错排值
	...
	n & 0 & 1 & 2 & 3 & 4 & 5 & 6 \\
	$D_n$ & 1 & 0 & 1 & 2 & 9 & 44 & 265\\ \hline
	n &7 &8 &9 &10 & 11 & 12 & 13\\
	$D_n$ &1845  &14833 &133496 &1334961 &14684570 &176214841 &2290792932 \\ \hline
	n &14 &15 &16 &17 \\
	$D_n$ &32071101049 &481066515734 &7697064251745 &130850092279664 \\ \hline
	\end{tabular}@

*相对位置上有限制的排列的问题：
*	求集合@$\{1, 2, 3, \cdots , n\}$@的不允许出现12,23,34, ... , (n-1)n的全排列数为@$$Q_n = n! - C_{n-1}^{1}(n-1)! + C_{n-1}^{2}(n-2)! - \cdots + (-1)^{n-1}C_{n-1}^{n-1}\cdot 1!$$@
...
*	棋子问题：在给定棋盘C中放入k个无区别的棋子，要求每个棋子只能放一格，且各子不同行不同列，求不同的放法数@$ r_k(C) $@
