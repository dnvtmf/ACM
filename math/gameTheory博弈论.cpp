...
SG定理：如果游戏G由n个子游戏组成，$G=G_1+G_2+G_3+ \cdots +G_n$, 并且第i个游戏sg函数值为$sg_i$, 则游戏G的sg函数值为$g=sg_1 \mbox{\textasciicircum} sg_2 \mbox{\textasciicircum} \cdots \mbox{\textasciicircum} sg_n$
