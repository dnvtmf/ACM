/*母函数
 * 普通母函数:
 * 定义：给定一个无穷序列@$(a_0, a_1, a_2, \cdots , a_n, \cdots)$@(简记为{@$a_n$@}),称函数
 * @$$	f(x) = a_0 + a_1x^1 + a_2 x^2 + \cdots + a_n x^n + \cdots = \sum_{i=1}^{\infty}{a_i x^i}	$$@
 * 为序列@$\{a_n\}$@的普通母函数
 * 常见普通母函数：
 ...
 *	@n是整数, 序列$(P_n^0, P_n^1, \cdots , P_n^n)$的指数母函数为$f_e(x)=(1+x)^n$@
