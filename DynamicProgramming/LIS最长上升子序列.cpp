...
/*五维偏序
	给一个长度为n的五维向量的序列A, q个询问(强制在线), 每个询问给一个五维向量b, 求序列中满足$A[i]_j \leq b_j, 1 \leq j \leq 5$的i的个数, $n, q \leq 50000$
	做法: bitset, 分块
	来源: 2015北京网络赛J题, http://hihocoder.com/problemset/problem/1236
*/
